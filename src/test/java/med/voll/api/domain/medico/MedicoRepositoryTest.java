...
public class MedicoRepositoryTest {
    ...
    void testElegirMedicoAleatorioDisponibleEnLaFechaEscenario1() {
        ...
        var medico = registrarMedico("Medico1", "meidco@correo.com", "12345", Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Paciente1", "paciente@correo.com", "123789");
